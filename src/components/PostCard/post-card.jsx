...
export default function PostCard({ props, isCurrent = false }) {
  ...
  const headerTitle = !isCurrent ? (
    <Link to={`/articles/${props.slug}`} params={{ slug: props.slug }}>
      <span className="post-card__info__title__header__title">
  ...
  const editButtons =
    isCurrent && isLoggedIn && isOwner ? (
      <div className="edit-buttons">
        ...
        <Link to={`/articles/${slug}/edit`} params={{ slug: props.slug }}>
  ...
  const description = isCurrent
    ...
    : props.description.length > 219
      ? props.description.slice(0, 220).concat("...")
      : props.description;

  let isLikedStyle = favorited
    ? "post-card__info__title__header__liked"
    : "post-card__info__title__header__unliked";
          ...
          <div className="post-card__info">
            ...
            <div className="post-card__author">
              <div className="post-card__author__info">
                <span className="post-card__author__info__username">
                  {props.author.username}
                </span>
                <span className="post-card__author__info__date-of-post">
